...
hm... I can fix this but before I try that I notice the button just below "explain  error". I clicked it and (after agreeing to all terms and conditions) I got a new window explaining the errors and suggesting better code. Huh, not bad!
